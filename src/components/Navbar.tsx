...
const Navbar = () => {
  ...
  const products = [
    { name: "GENTE", description: "Gestão de Pessoas", href: "/gente" },
    { name: "AstréIA", description: "Assistente Jurídico com IA", href: "/astreia" },
    { name: "UPGRADE", description: "Tecnologia Educacional", href: "/upgrade" },
    { name: "Gestão Sobre Rodas", description: "Gestão de ações de saúde", href: "/gestao-sobre-rodas" },
    { name: "VidAI", description: "Gestão Clínica com IA", href: "/vidai" },
    { name: "SUSGERI", description: "Saúde Gerencial e Integrado", href: "/susgeri" },
  ];
            ...
            >
              ...
              {isProductsOpen && (
                <motion.div
                  ...
                  className="absolute top-full -left-4 pt-3 w-64 z-50"
                >
